...
public abstract class MicroService implements Runnable {
     ...
     *                 queue.
     */
    protected final synchronized <T, E extends Event<T>> void subscribeEvent(Class<E> type, Callback<E> callback) {
        //TODO: implement this.
            ...
            synchronized (this) {
                try {
                    ...
                    if (msg instanceof Event) {
                        ...
                        Callback callback = brodcastCallbackMap.get(msg.getClass());
                        callback.call(msg);
                    }
                } catch (Exception e) {
                    e.printStackTrace();
